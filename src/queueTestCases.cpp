...
template<typename V>
using UnboundedQueues = ::testing::Types<FAAQueue<V>,LCRQueue<V>, LPRQueue<V>, LinkedMuxQueue<V>>;
template<typename V>
using BoundedQueues = ::testing::Types<BoundedCRQueue<V>, BoundedPRQueue<V>, BoundedMuxQueue<V>>;
